...
def generateEventMsg():
    ...
    msg.ip = '192.168.1.2'
    msg.port = 31122
    data = struct.pack('!HHBBQLLLHhBB',CRC, Len, SQC, MsgCnt, UtcTimeStamp, TimeStamp, MeasurementCounter, 
    CycleCounter, NofDetections, Vambig, CenterFreq, DetectionsInPacket);
